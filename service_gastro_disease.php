...
<html lang="en-US" class="no-js">
    ...
    width: 100%;
		...
		}.mungu-element.mungu-element-counter.uk-section.text-light {
										  ...
										  <div class="wpb_wrapper">
											 <ul class="uk-breadcrumb" prefix="">
												...
												<li typeof="v:Breadcrumb">
												   <a href="service_gastro_disease.php" class="title-sectio" rel="v:url" property="v:title">Gastroesophageal Reflux Disease (GERD)</a>
												</li>
											 </ul>
										  </div>
									   </div>
					...
					<div class="uk-container uk-position-relative">
					 <div class="uk-grid uk-flex uk-flex-center">
						<div id="services-sectio" class="medio-blog-container uk-width-1-1@s">
						   <article class="medio-blog-single uk-article post-149 service type-service status-publish has-post-thumbnail hentry service_category-service">
							  <div class="uk-text-center">
								 <h1 class='post-title medio-brand-title'>Gastroesophageal Reflux Disease (GERD) </h1>
							  </div>
							  <div class="medio-blog-content mb0">
								 <div class='post-content'>
									<div class="vc_row wpb_row vc_row-fluid vc_custom_1509351861122 vc_row-has-fill">
									   <div class="wpb_column vc_column_container vc_col-sm-12">
										  <div class="vc_column-inner ">
											 <div class="wpb_wrapper">
												<h2 style="font-size: 30px;line-height: 1.3em;text-align: center" class="vc_custom_heading" >Gastroesophageal Reflux Disease (GERD)</h2>
												<div  class="wpb_single_image wpb_content_element vc_align_center">
												   <figure class="wpb_wrapper vc_figure">
													  <div class="vc_single_image-wrapper   vc_box_border_grey"><img class="vc_single_image-img " src="wp-content/uploads/sites/31/2017/06/Gastro.jpg" width="1170" height="450" alt="service-urology" title="service-urology" /></div>
												   </figure>
												</div>
											 </div>
										  </div>
									...
									<div class="vc_row wpb_row vc_row-fluid">
									   <div class="wpb_column vc_column_container vc_col-sm-12">
										  <div class="vc_column-inner ">
											 <div class="wpb_wrapper" style="margin-left:10%;">
													  ...
													  <div class="vc_column-inner ">
														 <div class="wpb_wrapper">
															<div class="wpb_text_column wpb_content_element " >
															   <div class="wpb_wrapper">
																  <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">What is Gastroesophageal Reflux Disease (GERD) ?</p>
																  <p style="text-align:justify;">Gastroesophageal reflux is a physical condition in which acid from the stomach flows backward up into the esophagus. People will experience heartburn when excessive amounts of acid from the stomach reflux into the esophagus. Many describe heartburn as a feeling of burning discomfort, localized behind the chest, that moves up toward the neck and throat. Some even experience the bitter or sour taste of the acid in the back of the throat. The burning and pressure symptoms of heartburn can last for several hours and often worsen after eating food and even mimics a heart attack. All of us may have occasional heartburn. However, frequent heartburn (two or more times a week), food sticking, blood in throat or weight loss may be associated with a more severe GERD. Most people will experience heartburn if the lining of the esophagus comes in contact with too much stomach juice for too long a period of time. This stomach juice consists of acid and digestive enzymes. The prolonged contact of acidic stomach juice with the esophageal lining injures the esophagus and produce a burning discomfort. Normally, a muscular valve at the lower end of the esophagus called the lower esophageal sphincter or "LES" keeps the acid in the stomach and out of the esophagus. In GERD the LES relaxes too frequently, which allows stomach acid to reflux, or flow backward into the esophagus. GERD can also have extra-esophageal manifestations like chest pain, asthma, chronic cough, ear, nose and throat problems which often avoid detection.</p>
															   </div>
															</div>
															<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >What types of tests are needed to evaluate GERD ?</h4>
															<ul class='mungu-element icon-list-element' style="text-align: justify;">
															   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Often GERD can be clinically diagnosed basing on complaints of the patient. </li>
															   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Additional tests may be required when it is unclear whether your symptoms are caused by acid reflux. </li>
															   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>or if you suffer from complications of GERD such as dysphagia (difficulty in swallowing), bleeding, choking, or of your symptoms fail to improve with prescription medications. </li>
															   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>In all these conditions additional tests are to be conducted to confirm the diagnosis: Endoscopy, Esophageal Manometry or Esophageal pH, Upper GI barium Series.</li>
															</ul>
												...
												<!-- end .uk-slider -->
												<div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1509330035753">
												   <div class="wpb_column vc_column_container vc_col-sm-2">
													  <div class="vc_column-inner ">
														 <div class="wpb_wrapper"></div>
													  </div>
												   ...
												   <div class="wpb_column vc_column_container vc_col-sm-4">
													  <div class="vc_column-inner ">
														 <div class="wpb_wrapper">
															<div class="wpb_text_column wpb_content_element " >
															   <div class="wpb_wrapper">
																  <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">Lifestyle Changes to Reduce GERD</p>
																  <p style="text-align:justify;">Avoid foods and drinks that trigger heartburn. Small frequent meals are preferred. Do not lie down after you eat for about 3 hours.
																	 Stop using tobacco in any form. Do not consume excess alcohol. Avoid wearing tight clothes across your waist, stomach, or abdomen.
																	 Lose weight if you are overweight. Raise the head of your bed 6 to 8 inches can help in reducing reflux frequency. Limit or reduce stress in your life.
																  </p>
															   </div>
															</div>
														 </div>
												   ...
												   <div class="wpb_column vc_column_container vc_col-sm-4">
													  <div class="vc_column-inner ">
														 <div class="wpb_wrapper">
															<div class="wpb_text_column wpb_content_element " >
															   <div class="wpb_wrapper">
																  <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">Avoid Foods which can increase reflux</p>
																  <p style="text-align:justify;">Coffee, tea, and soft drinks that contain caffeine. Citrus juices and drinks, such as orange, grapefruit, lemon, lime, pineapple. Fatty or fried foods. Peppermint or spearmint, including flavouring. Spicy, highly seasoned foods. Chocolate and sweets can also increase symptoms.</p>
															   </div>
															</div>
														 </div>
													  </div>
