...
<html lang="en-US" class="no-js">
    ...
    width: 100%;
		...
		.vc_row.wpb_row.vc_row-fluid.pr6@s.pl6@s.vc_custom_1526664358618.vc_row-has-fill.vc_row-o-content-middle.vc_row-flex{
			left: -219.5px!important;
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<ul class="uk-breadcrumb" prefix="v: http://rdf.data-vocabulary.org/#">
														<li typeof="v:Breadcrumb"><a href="index.php" rel="v:url" property="v:title">Home</a></li><li typeof="v:Breadcrumb"><a href="service.php" rel="v:url" property="v:title">Service</a></li><li typeof="v:Breadcrumb"><a href="service_dyspepsia.php" rel="v:url" property="v:title">Dyspepsia </a></li>
													</ul>
												</div>
											</div>
										</div>
				...
				<div class="uk-container uk-position-relative">
					<div class="uk-grid uk-flex uk-flex-center">
						<div id="services-sectio" class="medio-blog-container uk-width-1-1@s">
							<article class="medio-blog-single uk-article post-141 service type-service status-publish has-post-thumbnail hentry service_category-service">
								<div class="uk-text-center"><h1 class='post-title medio-brand-title'>Dyspepsia </h1></div>
									<div class="medio-blog-content mb0">
										<div class='post-content'>
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1509351086640 vc_row-has-fill">
												<div class="wpb_column vc_column_container vc_col-sm-12">
													<div class="vc_column-inner ">
														<div class="wpb_wrapper">
															<h3 style="font-size: 30px;line-height: 1.3em;text-align: center" class="vc_custom_heading" >Dyspepsia </h3>
															<div  class="wpb_single_image wpb_content_element vc_align_center">	
																<figure class="wpb_wrapper vc_figure">
																	<div class="vc_single_image-wrapper   vc_box_border_grey"><img class="vc_single_image-img " src="wp-content/uploads/sites/31/2017/06/dyspepsia.gif" width="1170" height="450" alt="Cardiology" title="service-cardiology" /></div>
																</figure>
															</div>
														</div>
													</div>
											...
											<div class="vc_row wpb_row vc_row-fluid">
												<div class="wpb_column vc_column_container vc_col-sm-12">
													<div class="vc_column-inner ">
																	...
																	<div class="vc_column-inner ">
																		<div class="wpb_wrapper" style="margin-left:5%">
																			<div class="wpb_text_column wpb_content_element " >
																				<div class="wpb_wrapper">
																				<p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">What is Dyspepsia ?</p>
																					<p style="text-align:justify;">Indigestion, also known as dyspepsia, is a term used to describe one or more symptoms including a feeling of fullness during a meal, uncomfortable fullness after a meal, and burning or pain in the upper abdomen. Indigestion is common in adults and can occur once in a while or as often as every day. </p>
																				</div>
																			</div>
																			<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >Most people with indigestion experience more than one of the following symptoms:</h4>
																			<ul class='mungu-element icon-list-element' style="text-align: justify;">
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Fullness during a meal: The person feels overly full soon after the meal starts and cannot finish the meal. </li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Bothersome fullness after a meal: The person feels overly full soon after a meal it may feel like the food is staying in the stomach too long.
	 </li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Epigastric pain: The epigastric area is between the lower end of the chest bone and the navel. The person may experience epigastric pain ranging from mild to severe.
	</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Epigastric burning: The person feels an unpleasant sensation of heat in the epigastric area.
	 </li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Otherwise, less frequent symptoms that may occur with indigestion are nausea and bloating an unpleasant tightness in the stomach. Nausea and bloating could be due to causes other than indications.</li>
																			</ul><!-- end .icon-list-element -->
																			
																			
																			<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >Lifestyle changes to reduce symptoms:</h4>
																			<ul class='mungu-element icon-list-element' style="text-align: justify;">
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Avoid foods and drinks that trigger symptoms.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid late evening snacks.	</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Lose weight if you are overweight. Obesity can increase Reflux.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Eat 5 or 6 small meals during the day, Not 3 large ones.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid tobacco in any form</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Raise the head of your bed 6 to 8 inches.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Eat slowly take small mouthfuls and chew well.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid alcohol.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Limit or reduce stress in your life. Try participating in an exercise, yoga, or meditation program.
																				</li><li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Do not lie down right after you eat. Remain upright for at least two hours.
																				</li><li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid wearing tight clothes across your waist, stomach or abdomen.
																				</li><li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Take your medicines exactly as your doctor prescribe.</li>
																			</ul><!-- end .icon-list-element -->
																			
																			
																			
																			<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >Avoid the foods listed below:</h4>
																			<ul class='mungu-element icon-list-element' style="text-align: justify;">
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Coffee, tea, and soft drinks that contain caffeine. </li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Peppermint or spearmint, including flavouring.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Citrus juices and drinks, such as Orange, grapefruit, lemon, lime, pineapple.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Spicy, highly seasoned food.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Tomato based dishes, such as spaghetti with sauce, Chili, and pizza.</li>
																				<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Food that is very hot or very cold.
																			 </li><li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Chocolate and sweets, if they cause symptoms.
																			 </li><li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Fatty or fried foods.
																			</li>
																			</ul><!-- end .icon-list-element -->
																		</div>
																	</div>
														...
														<div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1491224110587">
															<div class="wpb_column vc_column_container vc_col-sm-2">
																<div class="vc_column-inner ">
																	<div class="wpb_wrapper"></div>
																</div>
									...
									<!--<hr class='mb3'>-->
									<div class="uk-clearfix clearfix"></div><div class='uk-clearfix'></div>                    
