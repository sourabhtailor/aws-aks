							   ...
							   <div class="wpb_wrapper">
								  <ul class="uk-breadcrumb" prefix="v: http://rdf.data-vocabulary.org/#">
									 ...
									 <li typeof="v:Breadcrumb">
										<a href="service.php" rel="v:url" property="v:title">Service</a>
									 </li>
									 <li typeof="v:Breadcrumb">
										<a href="service_irritable_bowel_syndrome.php" class="title-sectio" rel="v:url" property="v:title">Irritable Bowel Syndrome (IBS)</a>
									 </li>
								  </ul>
							   </div>
							</div>
	   ...
	   <div class="uk-container uk-position-relative">
		  <div class="uk-grid uk-flex uk-flex-center">
			 <div id="services-sectio" class="medio-blog-container uk-width-1-1@s">
				<article class="medio-blog-single uk-article post-144 service type-service status-publish has-post-thumbnail hentry service_category-service">
				   <div class="uk-text-center">
					  <h1 class='post-title medio-brand-title'>Irritable Bowel Syndrome (IBS)</h1>
				   </div>
				   <div class="medio-blog-content mb0">
					  <div class='post-content'>
						 <div class="vc_row wpb_row vc_row-fluid vc_custom_1509351181954 vc_row-has-fill">
							<div class="wpb_column vc_column_container vc_col-sm-12">
							   <div class="vc_column-inner ">
								  <div class="wpb_wrapper">
									 <h2 style="font-size: 30px;line-height: 1.3em;text-align: center" class="vc_custom_heading" >Irritable Bowel Syndrome (IBS)</h2>
									 <div  class="wpb_single_image wpb_content_element vc_align_center">
										<figure class="wpb_wrapper vc_figure">
										   <div class="vc_single_image-wrapper   vc_box_border_grey"><img class="vc_single_image-img " src="wp-content/uploads/sites/31/2017/06/irritabl.jpg" width="1200" height="500" alt="service-pulmonology" title="service-pulmonology" /></div>
										</figure>
									 </div>
								  </div>
							   </div>
							...
							<div class="wpb_column vc_column_container vc_col-sm-12">
							   <div class="vc_column-inner ">
								  <div class="wpb_wrapper">
										   ...
										   <div class="vc_column-inner ">
											  <div class="wpb_wrapper">
												 <div class="wpb_text_column wpb_content_element " >
													<div class="wpb_wrapper">
													   <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">What is Irritable Bowel Syndrome (IBS) ?</p>
													...
													<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >IBS triggers vary from person to person</h4>
													<ul class='mungu-element icon-list-element' style="text-align:justify;">
													   <p>Stimuli that don't bother other people can trigger symptoms in people with IBS but not all people with the condition created to the same stimuli. Common triggers include:</p>
													   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Hormones - Researchers believe that hormonal changes play a role in this condition. Many women find that signs and symptoms are worse during or around their menstrual periods. </li>
													   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Foods - Chocolate, spices, fats, fruits, beans cabbage, cauliflower, broccoli, milk </li>
													   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Other illnesses - Sometimes another illness, such as an acute episode of infectious diarrhoea (gastroenteritis) or too many bacteria in the intestine (bacterial overgrowth), can trigger IBS.</li>
													   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Stress - Most people with IBS find that their signs and symptoms are worse more frequent during periods of increased stress.</li>
													</ul>
													<!-- end .icon-list-element -->
												 </div>
												 <h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >Lifestyle modification</h4>
												 <ul class='mungu-element icon-list-element' style="text-align:justify;">
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Stop smoking and tobacco use.</li>
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Drink adequate amount of water.</li>
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Avoid excessive alcohol consumption.</li>
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid excessive coffee/caffeine and chewing gum.</li>
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Use relaxation techniques: deep breathing, meditation, Yoga.</li>
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Make sure you eat regular and controlled meals as advised by your doctor/dietitian.</li>
													<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Exercise regularly: Exercise helps relieve depression and stress, stimulates normal constructions of your intestines.</li>
												 </ul>
												 <!-- end .icon-list-element -->
											  </div>
										   </div>
									 ...
									 <div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1509329982749">
										<div class="wpb_column vc_column_container vc_col-sm-2">
										   <div class="vc_column-inner ">
											  <div class="wpb_wrapper"></div>
										   </div>
										...
										<div class="wpb_column vc_column_container vc_col-sm-4">
										   <div class="vc_column-inner ">
											  <div class="wpb_wrapper">
												 <div class="wpb_text_column wpb_content_element " >
													<div class="wpb_wrapper">
													   <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;    letter-spacing: -1.12px;">Foods to choose (low FODMAP diet)</p>
													   <p style="text-align:justify;">Following foods reduces symptoms and improves quality of life.</p>
													   <ul class='mungu-element icon-list-element' style="text-align:justify;">
														  <li style="letter-spacing: -0.5px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Fruits - Banana, muskmelon, grapes, kiwi, lemon, Orange, pineapple. </li>
														  <li style="letter-spacing: -0.5px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Vegetables - Carrot, cabbage, broccoli, cucumber, green beans. </li>
														  <li style="letter-spacing: -0.2px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> cereals and grains - Biscuits, cereals, noodles, gluten free breads.</li>
														  <li style="letter-spacing: -0.2px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Meat, fish and poultry - Chicken, lamb, pork, eggs and fish.</li>
														  <li style="letter-spacing: -0.2px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Milk alternatives - Lactose free milk and its products, rice or coconut.</li>
														  <li style="letter-spacing: -0.5px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Beverages - Water, fruit or vegetable juices, tea or coffee.</li>
														  <li style="letter-spacing: -0.5px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Exercise regularly: Exercise helps relieve depression and stress, stimulates normal constructions of your intestines.</li>
													   </ul>
													   <!-- end .icon-list-element -->
													</div>
												 </div>
										...
										<div class="wpb_column vc_column_container vc_col-sm-4">
										   <div class="vc_column-inner ">
											  <div class="wpb_wrapper">
												 <div class="wpb_text_column wpb_content_element " >
													<div class="wpb_wrapper">
													   <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;    letter-spacing: -1.12px;">Foods to avoid (High FODMAP diet)</p>
													   <p style="text-align:justify;">Following foods reduces symptoms and improves quality of life.</p>
													   <ul class='mungu-element icon-list-element' style="text-align:justify;    letter-spacing: 1.2px;
														  ">
														  <li style="letter-spacing: -0.2px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Fruits - Apples, Apricot, blackberries, canned fruit, dates, dried fruits. </li>
														  <li style="letter-spacing: -0.5px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Vegetables - Garlic, onion, cauliflower, peas, mushrooms .</li>
														  <li style="letter-spacing: -0.2px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> cereals and grains - Barley, bran, muesli, rye, semolina, wheat.</li>
														  <li style="letter-spacing: -0.2px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>High lactose diary - Milk, butter milk, cream, ice cream, cheese, custard.</li>
														  <li style="letter-spacing: -0.5px;"><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Beverages - Cold drinks, coconut water, sodas, fennel tea, herbal tea.</li>
													   </ul>
													   <!-- end .icon-list-element -->
													</div>
												 </div>
									 ...
									 <div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1491224137049">
										<div class="wpb_column vc_column_container vc_col-sm-2">
										   <div class="vc_column-inner ">
											  <div class="wpb_wrapper"></div>
										   </div>
