                ...
                <div class="uk-flex uk-child-width-1-2 medio-responsive-menu uk-hidden@m uk-padding-small">
                    ...
                    <div class="uk-flex uk-flex-middle uk-flex-right">
						<a href="#offcanvas" class="hamburger-menu uk-navbar-toggle uk-navbar-toggle-icon uk-icon">
							<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect y="9" width="20" height="2"></rect>
							<rect y="3" width="20" height="2"></rect><rect y="15" width="20" height="2"></rect></svg>
						</a>
                    </div>
                </div>
												...
												<div class="vc_column-inner ">
													<div class="wpb_wrapper">
														<ul class="uk-breadcrumb" prefix="v: http://rdf.data-vocabulary.org/#">
															...
															<li typeof="v:Breadcrumb"><a href="service_hepatitis_b.php" rel="v:url" property="v:title">Hepatitis B</a></li>
														</ul>
													</div>
												</div>
											</div>
					...
					<div class="uk-container uk-position-relative">
						<div class="uk-grid uk-flex uk-flex-center">
							<div id="services-sectio" class="medio-blog-container uk-width-1-1@s">
								<article class="medio-blog-single uk-article post-146 service type-service status-publish has-post-thumbnail hentry service_category-service">
									<div class="uk-text-center"><h1 class='post-title medio-brand-title'>Hepatitis-B</h1></div>
										<div class="medio-blog-content mb0">
											<div class='post-content'>
												<div class="vc_row wpb_row vc_row-fluid vc_custom_1509349636182 vc_row-has-fill">
													<div class="wpb_column vc_column_container vc_col-sm-12">
														<div class="vc_column-inner">
															<div class="wpb_wrapper">
																<h2 style="font-size: 30px;line-height: 1.3em;text-align: center" class="vc_custom_heading" >Hepatitis-B</h2>
																<div  class="wpb_single_image wpb_content_element vc_align_center">
																	<figure class="wpb_wrapper vc_figure">
																		<div class="vc_single_image-wrapper   vc_box_border_grey">
																			<!--<img class="vc_single_image-img " src="wp-content/uploads/sites/31/2017/30/new_images/img6.jpg" width="1170" height="450" alt="service-neyrology" title="service-neyrology" />-->
																		</div>
																	</figure>
																</div>
															</div>
													...
													<div class="wpb_column vc_column_container vc_col-sm-12">
														<div class="vc_column-inner ">
															<div class="wpb_wrapper" style="margin-left:5%;>
																		...
																		<div class="vc_column-inner ">
																			<div class="wpb_wrapper">
																				<div class="wpb_text_column wpb_content_element " >
																					<div class="wpb_wrapper">
																						<p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">What is Hepatitis-B ?</p>
																						<p style="text-align:justify;">Hepatitis-B is a serious liver infection caused by the Hepatitis-B virus (HBV). For some people, Hepatitis-B infection Becomes chronic, meaning it lasts more than six months. Having chronic Hepatitis-B increase your risk of developing cirrhosis-a condition that causes permanent scarring of the liver, liver failure or liver cancer. Most adults infected with Hepatitis-B recover fully, even if their signs and symptoms are severe. Infants and children are more likely to develop a chronic Hepatitis-B infection. A vaccine can prevent Hepatitis-B. Taking certain precautions can help to prevent spreading of HBV to others. Signs and symptoms of Hepatitis-B, ranging from mild to severe, usually appear about 1-3 months after you have been infected. Signs and symptoms of Hepatitis-B may include: Abdominal pain, Dark urine, Fever, Joint pain, Loss of appetite, Nausea and vomiting, Weakness and fatigue, Yellowing of your skin and the whites of your eyes (jaundice) Hepatitis-B infection is caused by the hepatitis B virus (HBV). The virus is passed from person to person through blood, semen or other body fluids.</p>
																						<p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">Common ways HBV is transmitted include</p>
																						<p style="text-align:justify;">Sexual contact. You may become infected if you have unprotected sex with an infected partner whose blood, saliva, semen or vaginal secretions enter your body.</p>
																						<p style="text-align:justify;">Sharing of needles. HBV is easily transmitted through needles and syringes contaminated with infected blood. Sharing intravenous (IV) drug paraphernalia puts you at high risk of Hepatitis-B.</p>
																						<p style="text-align:justify;">Accidental needle sticks. Hepatitis-B is a concern for health care workers and anyone else comes in contact with human blood.</p>
																						<p style="text-align:justify;">Mother to child. Pregnant women infected with HBV can pass the virus to their babies during childbirth. However, the newborn can be vaccinated to avoid getting infected in almost all cases. Talk to your doctor about being tested for Hepatitis-B if you are pregnant or want to become pregnant.</p>
																					</div>
																				</div>
																				<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >Steps to reduce the risk of passing Hepatitis-B to others</h4>
																				<ul class='mungu-element icon-list-element' style="text-align: justify;">
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Vaccinate your family or close contacts</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Don't donate blood, body organs or semen.</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Have protected sex</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Stop drinking alcohol</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Don't share razors or toothbrushes.</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid medications that may causes liver damage. Stop self medication.</li>
																				</ul><!-- end .icon-list-element -->
																				<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" class="vc_custom_heading" >Dietary advice</h4>
																				<ul class='mungu-element icon-list-element' style="text-align: justify;">
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Eat regular and balanced meals.</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Eat lots of fruits and vegetables.</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Maintain healthy calorie intake.</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Get adequate protein, and Drink enough fluids</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Eat whole-grain cereals, breads, and grains.</li>
																					<li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid fatty, salty, and sugary foods</li>
																				</ul><!-- end .icon-list-element -->
																			</div>
																		</div>
																	</div>
																...
																<div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1491224150998">
																	<div class="wpb_column vc_column_container vc_col-sm-2">
																		<div class="vc_column-inner ">
																			<div class="wpb_wrapper"></div>
																		</div>
