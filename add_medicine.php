					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="manage_medicine.php">Manage Medicine</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent" style="border-top: 1px solid;border-color: #bbb2b2;">
									<form action="script_add_medicine.php" method="post" enctype="multipart/form-data" id="myform" class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												<label class="control-label col-md-3">Medicine Name<span class="required"> * </span></label>
												<div class="col-md-5">
													<input type="text" name="txt_name" id="txt_name" data-required="1" placeholder="Enter Medicine Name" class="form-control input-height" required />
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label col-md-3">Medicine MGML<span class="required">  </span></label>
												<div class="col-md-5">
													<input name="mgml" id="mgml" type="text" placeholder="MGML" class="form-control input-height"  /> 
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label col-md-3">Comment<span class="required">  </span></label>
												<div class="col-md-5">
													<input name="comment" id="comment" type="text" placeholder="Comment" class="form-control input-height"  /> 
												</div>
											</div>
											...
											<div class="form-actions">
												<div class="row">
													<div class="offset-md-3 col-md-9">
														...
														<a href="manage_medicine.php" class="btn btn-default">Cancel</a>
													</div>
												</div>
											</div>
										</div>
