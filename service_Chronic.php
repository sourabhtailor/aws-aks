...
<html lang="en-US" class="no-js">
	...
	<head>
		...
		<title>Chronic Constipation</title>
								   ...
								   <div class="vc_column-inner ">
									  <div class="wpb_wrapper">
										 <ul class="uk-breadcrumb" prefix="">
											...
											<li typeof="v:Breadcrumb"><a href="service_Chronic.php" rel="v:url" property="v:title">Chronic Constipation</a></li>
										 </ul>
									  </div>
								   </div>
								</div>
			  ...
			  <div class="uk-container uk-position-relative">
				 <div class="uk-grid uk-flex uk-flex-center">
					<div id="services-sectio" class="medio-blog-container uk-width-1-1@s">
					   <article class="medio-blog-single uk-article post-151 service type-service status-publish has-post-thumbnail hentry service_category-service">
						  <div class="uk-text-center">
							 <h1 class='post-title medio-brand-title'>Chronic Constipation</h1>
						  </div>
						  <div class="medio-blog-content mb0">
							 <div class='post-content'>
								<div class="vc_row wpb_row vc_row-fluid vc_custom_1509351821532 vc_row-has-fill">
								   <div class="wpb_column vc_column_container vc_col-sm-12">
									  <div class="vc_column-inner ">
										 <div class="wpb_wrapper">
											<h2 style="font-size: 30px;line-height: 1.3em;text-align: center" class="vc_custom_heading" >Chronic Constipation
											</h2>
											<div  class="wpb_single_image wpb_content_element vc_align_center">
											   <figure class="wpb_wrapper vc_figure">
												  <div class="vc_single_image-wrapper   vc_box_border_grey">
													<!--<img class="vc_single_image-img " src="wp-content/uploads/sites/31/2017/30/h2.jpeg" width="1170" height="450" alt="service-radiology" title="service-radiology" />-->
												</div>
											   </figure>
											</div>
										 </div>
								   ...
								   <div class="wpb_column vc_column_container vc_col-sm-12">
									  <div class="vc_column-inner ">
										 <div class="wpb_wrapper">
												  ...
												  <div class="vc_column-inner ">
													 <div class="wpb_wrapper">
														<div class="wpb_text_column wpb_content_element " >
														   <div class="wpb_wrapper">
															  <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;">What is Chronic Constipation?</p>
															  <p style="text-align: justify;">Chronic constipation is infrequent bowel movements or difficult passage of stool that persists for several weeks or longer. Though occasional constipation is very common, some people experience chronic constipation that can interfere with their ability to go about their daily tasks. Chronic constipation may also cause excessive straining to have a bowel movement. Treatment for chronic constipation depends in part on the underlying cause. However, in many cases, a cause is never found. Improper bowel training during childhood can lead to chronic constipation in adult life. Signs and symptoms of chronic constipation include one or more of following: Passing fewer stools than normal Having lumpy or hard stools Straining to have bowel movements Feeling as though there's a blockage in your rectum that prevents bowel movements Feelings as though you can't completely empty the stool from your rectum Needing help to empty your rectum, such as using your hands to press on your abdomen and using a finger to remove stool from your rectum Constipation most commonly occurs when waste or stool moves too slowly through the digestive tract or cannot be eliminated effectively from the rectum, which may cause the stool to become hard and dry.</p>
															  <p style="text-align: justify;">Signs and symptoms of chronic constipation include one or more of following: Passing fewer stools than normal Having lumpy or hard stools Straining to have bowel movements Feeling as though there's a blockage in your rectum that prevents bowel movements Feelings as though you can't completely empty the stool from your rectum Needing help to empty your rectum, such as using your hands to press on your abdomen and using a finger to remove stool from your rectum Constipation most commonly occurs when waste or stool moves too slowly through the digestive tract or cannot be eliminated effectively from the rectum, which may cause the stool to become hard and dry.</p>
														   </div>
														</div>
														<h4 style="text-align: left;font-weight: 600;font-family:Open Sans, Arial, sans-serif;" >Lifestyle Modification</h4>
														<ul class='mungu-element icon-list-element' style="text-align: justify;">
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Exercise regularly: Exercise helps relieve  depression and stress, stimulates normal contractions of your intestines, and can help you feel better about yourself. If you have been inactive, start slowly and gradually increase the amount of time you exercise. If you have other medical problems, check with your doctor before starting an exercise program. </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Drink plenty of water and liquids. </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Eat 5 or 6 small meals during the day, not 3 large ones.
														   </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Eat 3-4 hours before going to sleep to fully digest the meal.</li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Don't ignore the urge to have a bowel movement. Take your time in the bathroom, allowing yourself enough time to have a bowel movement without distractions and without feeling rushed.
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Eat high fiber diet, plenty of fruits and green leafy vegetables.
														   </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Stop smoking for overall good health.
														   </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Avoid coffee/ caffeine and chewing gum.
														   </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i> Make sure you eat regular and controlled meals as advised by your doctor/dietician.
														   </li>
														   <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Avoid alcohol consumption and Try to manage stress.</li>
														   </li>
														</ul>
											...
											<div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1509330026326">
											   <div class="wpb_column vc_column_container vc_col-sm-2">
												  <div class="vc_column-inner ">
													 <div class="wpb_wrapper"></div>
												  </div>
													 ...
													 <div class="wpb_wrapper">
														<div class="wpb_text_column wpb_content_element " >
														   <div class="wpb_wrapper" style="">
															  <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;margin-top: -17%;">Diet</p>
															  <ul class='mungu-element icon-list-element' style="text-align: justify;">
																 <p style="text-align:justify;">In many cases, simple changes in your diet can provide relief. Although your body may not respond immediately to these changes, your goal is to find long term, not temporary, solutions:</p>
																 <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>add fiber in your diet it helps to reduce constipation. The best approach is to Slowly increase the amount of fiber in your diet over a period of weeks. If your signs and symptoms remain the same or worse, tell your doctor. </li>
																 <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Some people do better limiting dietary fiber and instead take a fiber supplement that causes less gas and bloating. If you take a fiber supplement, introduce it slowly and drink plenty of water everyday to reduce gas, bloating and constipation. </li>
															  </ul>
														   </div>
														</div>
													 </div>
												  ...
												  <div class="vc_column-inner ">
													 <div class="wpb_wrapper">
														<div class="wpb_text_column wpb_content_element " >
														   <div class="wpb_wrapper">
															  <ul class='mungu-element icon-list-element' style="text-align: justify;">
																 <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Include plenty of high-fiber foods in your diet, including beans, Green Leafy vegetables, salad, fruits, whole grain cereals and bran.
																 </li>
																 <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Eat fewer foods with low amounts of fiber such as processed food, and dairy and meat products.</li>
																 <li><i class='fa fa-long-arrow-right'  style='color: rgba(0,0,0,0.5);'></i>Drink plenty of fluids.
																 <li>
															  </ul>
														   </div>
														</div>
											   ...
											   <div class="wpb_column vc_column_container vc_col-sm-4">
												  <div class="vc_column-inner ">
													 <div class="wpb_wrapper">
														<div class="wpb_text_column wpb_content_element " >
														   <div class="wpb_wrapper">
															  <p style="font-size: 130%;font-style: initial;text-align:justify;font-weight: 600;color: black;letter-spacing: 1px;">Which type of toilet seat helps in better ball movement?</p>
															  <p style="text-align:justify;">The Indian Squatting commode is best for proper bowel movement. If the Western commode is used, the placement of a rise stool at the foot helps. This is illustrated in the diagram below.</p>
														   </div>
														</div>
													 </div>
												  </div>
											...
											<div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1491224206948">
											   <div class="wpb_column vc_column_container vc_col-sm-2">
												  <div class="vc_column-inner ">
													 <div class="wpb_wrapper"></div>
												  </div>
