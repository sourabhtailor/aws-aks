...
$notification = '';
	if (isset($_SESSION['success_msg1'])) {
		$notification = '<div role="alert" class="alert alert-success"><button type="button" class="close" id="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><strong>Success!</strong> ' . $_SESSION['success_msg1'] . '</div>';
		unset($_SESSION['success_msg1']);
	}
	if (isset($_SESSION['failure_msg1'])) {
		$notification = '<div role="alert" class="alert alert-danger"><button type="button" class="close" id="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><strong>Failed!</strong> ' . $_SESSION['failure_msg1'] . '</div>';
		unset($_SESSION['failure_msg1']);
												...
												<div class="vc_column-inner ">
													<div class="wpb_wrapper">
														<ul class="uk-breadcrumb" prefix="#">
															...
															<a href="forgot_password.php" rel="v:url" property="v:title">Forgot Password</a></li>
														</ul>
													</div>
												</div>
											</div>
									...
									<div class="vc_row wpb_row vc_row-fluid vc_custom_1491236164137">
										...
										<div class="wpb_column vc_column_container vc_col-sm-9 text-center">
											<div class="form-section">
												<form action="script_forgot_pass.php" id="myform" name="resetpass" enctype="multipart/form-data" method="post">
													<div class="tab-content" id="myTabContent">
														<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
														<?php echo $notification; ?>
															<h3 class="register-heading">Register Your Email To Get Your Password</h3>
															<div class="row">
																<div class="col-md-6 forgot-section">
																	<div class="form-group">
																		<input type="email" name="txt_email" id="txt_email" class="form-control" placeholder="Enter Registered Email *" value="" required />
																	</div>
																</div>
