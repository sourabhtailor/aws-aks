...
$notification = '';
	if (isset($_SESSION['msg1'])) {
		$notification = '<div role="alert" class="alert alert-success" style="background-color:#cec7c7;border-color:#cec7c7;width: 35%;
    margin-left: 45%;"><button type="button" class="close" id="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><strong>Success!</strong> ' . $_SESSION['msg1'] . '</div>';
		unset($_SESSION['msg1']);
	}
	if (isset($_SESSION['error1'])) {
		$notification = '<div role="alert" class="alert alert-danger" style="background-color:#cec7c7;border-color:#cec7c7;width: 35%;
    margin-left: 45%;"><button type="button"  class="close" id="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><strong>Failed!</strong> ' . $_SESSION['error1'] . '</div>';
...
<head>
    ...
    transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;
		...
		.vc_row.wpb_row.vc_inner.vc_row-fluid.vc_custom_1551767028403{
		...
		}input[type="radio"]:checked, input[type="radio"]:indeterminate {
										...
										<div class="vc_column-inner ">
											<div class="wpb_wrapper">
												<ul class="uk-breadcrumb" prefix="v: http://rdf.data-vocabulary.org/#">
													...
													<a href="register.php" rel="v:url" property="v:title">Register</a></li>
												</ul>
											</div>
										</div>
									</div>
						...
						<article class="medio-page-single uk-article post-83 page type-page status-publish hentry">							
							...
							<?php echo $notification; ?>
								<div class="wpb_column vc_column_container vc_col-sm-3 text-center">
									<div class="login-tex" style="margin-top:60px;">
									<h3 style="margin-top: 26%;font-size: xx-large;">Welcome</h3>
								...
								<div class="wpb_column vc_column_container vc_col-sm-9 text-center">
									<div class="form-section">
										<form action="script_registeration.php" name="reg" enctype="multipart/form-data" id="myform" method="post" autocomplete="off">
											<div class="tab-content" id="myTabContent">
												<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
													<h3 class="register-heading">Register To Get More Services</h3>
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
																<input type="text" class="form-control" placeholder="Enter First Name *" id="txt_name" name="txt_name" value="" required autocomplete="off"/>
															</div>
															<div class="form-group">																
																<input type="text" class="form-control" placeholder="Enter Last Name *" id="txt_lname" name="txt_lname" value="" required />
															</div>
															<div class="form-group">
																<input type="email" class="form-control" placeholder="Enter Email *" id="txt_email" name="txt_email" autocomplete="off" value="" required />																
															</div>
															<div class="form-group">																
																<input type="text" minlength="10" maxlength="10" id="txtEmpPhone" name="txtEmpPhone" class="form-control" placeholder="Enter Phone *" value="" required />
															</div>
															<div class="form-group">
																<input type="text" id="txt_age" name="txt_age" class="form-control" placeholder="Enter Age *" value="" required />																
															</div>
															<div class="form-group">
																<input type="text" class="form-control" name="txt_pincode" minlength="6" maxlength="6" placeholder="Enter Pin Code *" value="" required id="txt_pincode" />
															</div>
															<div class="form-group">
																<input type="text" class="form-control" name="txt_city" placeholder="Enter City *" value="" required id="txt_city" />
															</div>	
															<div class="form-group">
																<input type="text" class="form-control" name="txt_state" placeholder="Enter State *" value="" required id="txt_state" />
															</div>
															<div class="form-group">
																<input type="password" class="form-control"  id="txt_pass" name="txt_pass" placeholder="Enter Password *" value="" required />
															</div>
															<div class="form-group">
																<input type="password" class="form-control"  id="txt_cnpass" name="txt_cnpass" placeholder="Confirm Password *" value="" required />
															</div>
															<div class="form-group" style="width:98%;">
																<textarea rows="1" cols="50" class="form-control"  id="txt_address" name="txt_address"  placeholder="Enter Address *"></textarea>
															</div>
															<div class="form-group">
															...
															<div class="form-group" style="margin:1px 3px 4px -80px;">
																<input type="submit" class="btnRegister"  name="btnsubmit" id="btn_submit" style="background-color:#3a358a;" value="Register"/>
															</div>
														</div>
													</div>
												</div>
	...
	$(document).ready(function () {
		...
		$('#myform').validate({
			...
			messages: {
				...
				txt_pass: {
					required:"Password at least have 1 uppercase, 1 lowercase, 1 special character and 1 digit",
