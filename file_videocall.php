        ...
        <div class="card" style="margin-top: 0px; margin-bottom: 0px;">
          <div class="row card-content" style="margin-bottom: 0px;">
              <div class="input-field" style="display:none;">
                ...
                <input type="text" placeholder="App ID" name="appID" value="70bd2b2a30ea4fcf9e6650a8e0045f79">
              </div>
              <div class="input-field">
                <label for="channel" class="active">Channel</label>
                <input type="text" placeholder="channel" name="channel" id="channel" value="<?php echo $channel_id;?>">
              </div>
              <div class="input-field">
                <label for="token" class="active">Token</label>
                <input type="text" placeholder="token" name="token">
              </div>
			  <input type="text" name="bookid" id="bookid" style="display:none;" value="<?php echo $bookid;?>">
        ...
        console.log("leave")
		 var bookid = $('#bookid').val();
		  ...
		  $.ajax({
			...
			data: {leave:'leave',bookid:bookid,cId:cId},
			success: function (d) {
				if (d.data){
					console.log('success!');
				}
